...
if __name__ == '__main__':
    ...
    parser.add_argument("--phase",type = str,help = "  ",default='TEST')
    parser.add_argument("--train_data",type=str,help="  ",default='data_arti_sin2.csv')
    parser.add_argument("--test_data",type=str,help="  ",default='data_arti_sin2.csv')
